---
name: "machine-downtime-log-api"
description: "FastAPI web service with vLLM integration for machine downtime logging"
---

# Machine Downtime Log API

A FastAPI web service that logs machine stoppages and integrates with a vLLM model running on port 8008 for natural language query support.
